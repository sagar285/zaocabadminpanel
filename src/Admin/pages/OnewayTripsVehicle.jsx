...
import { useGetTripsofOnewayVehicleByAdminQuery, useGetUserTripsQuery, useLazyUsersearchTripsQuery } from "../Redux/Api";
import Sidebar from "../Component/Sidebar";
import { useNavigate } from "react-router-dom";
import { Search } from 'lucide-react';

const OneWayTripsVehicle = () => {
  ...
  // Get paginated data
  const { data: paginatedData, error, isLoading } = useGetTripsofOnewayVehicleByAdminQuery({
    page: currentPage,
    limit,
  });
...
export default OneWayTripsVehicle;