...
import { useGetTripsofCarpoolVehicleByAdminQuery, useGetUserTripsQuery, useLazySearchCarpoolTripsQuery, useLazyUsersearchTripsQuery } from "../Redux/Api";
import Sidebar from "../Component/Sidebar";
import { useNavigate } from "react-router-dom";
import { Search } from 'lucide-react';

const CarpoolTripsVehicle = () => {
  ...
  // Get paginated data
  const { data: paginatedData, error, isLoading } = useGetTripsofCarpoolVehicleByAdminQuery({
    page: currentPage,
    limit,
  });

  // Search functionality
  const [triggerSearch, { data: searchData }] = useLazySearchCarpoolTripsQuery();
            ...
            <table className="w-full bg-white border border-gray-300 table-fixed">
              <thead>
                <tr className="bg-gray-100 border-b">
                  ...
                  <th className="text-left py-2 px-3 font-semibold text-xs w-24">trip {'\n'} owner</th>
                  ...
                  <th className="text-left py-2 px-3 font-semibold text-xs w-24">passengers</th>
                  ...
                  return (
                    <tr key={trip._id || index} className="border-b hover:bg-gray-50">
                      ...
                      <td className="py-2 px-3 text-xs text-blue-600">
                        <a href={`/carpoolTrip/${trip?._id || '#'}`} className="text-blue-500 hover:underline">View</a>
                      </td>
                    </tr>
                  );
                })}
...
export default CarpoolTripsVehicle;